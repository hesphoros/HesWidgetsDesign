...
// HesAppBarType
//---------------------------------------------------------------------------
Q_ENUM_BEGIN(HesAppBarType)
    enum ButtonType
    {
        RouteBackButtonHint     = 0x0001,  /*!< 路由返回按钮提示  */
        NavigationButtonHint    = 0x0002,  /*!< 导航按钮提示      */
        StayTopButtonHint       = 0x0004,  /*!< 置顶按钮提示      */
        ThemeChangeButtonHint   = 0x0008,  /*!< 主题切换按钮提示  */
        MinimizeButtonHint      = 0x0010,  /*!< 最小化按钮提示    */
        MaximizeButtonHint      = 0x0020,  /*!< 最大化按钮提示    */
        CloseButtonHint         = 0x0040,  /*!< 关闭按钮提示      */
    };
Q_ENUM_REGISTER(ButtonType)
...
Q_ENUM_REGISTER(CustomArea)

enum WMMouseActionType 
{ 
    WMLBUTTONDOWN   = 0x0001,   /*!< 非客户区鼠标左键按下 */
    WMLBUTTONUP     = 0x0002,   /*!< 非客户区鼠标左键抬起 */
    WMLBUTTONDBLCLK = 0x0004,   /*!< 非客户区鼠标左键双击 */
    WMNCLBUTTONDOWN = 0x0008,   /*!< 非客户区鼠标左键按下 */
};

Q_ENUM_REGISTER(WMMouseActionType)
Q_DECLARE_FLAGS(WMMouseActionTypes, WMMouseActionType)
Q_ENUM_END(HesAppBarType)
Q_DECLARE_OPERATORS_FOR_FLAGS(HesAppBarType::ButtonFlags)
Q_DECLARE_OPERATORS_FOR_FLAGS(HesAppBarType::WMMouseActionTypes)
//---------------------------------------------------------------------------
// End HesAppBarType
//---------------------------------------------------------------------------
...
Q_ENUM_BEGIN(HesTextType)
enum TextStyle
{
    NoStyle     = 0x0000,    /*!< 无样式        */
    Caption     = 0x0001,    /*!< 标题样式      */
    Body        = 0x0002,    /*!< 正文样式      */
    BodyStrong  = 0x0003,    /*!< 强调正文样式  */
    Subtitle    = 0x0004,    /*!< 副标题样式    */
    Title       = 0x0005,    /*!< 标题样式      */
    TitleLarge  = 0x0006,    /*!< 大标题样式    */
    Display     = 0x0007,    /*!< 显示样式      */
};
Q_ENUM_REGISTER(TextStyle)
Q_ENUM_END(HesTextType)
...
Q_ENUM_REGISTER(IconName)
Q_ENUM_END(HesIconType)

//---------------------------------------------------------------------------
//End of HesIconType enum definition
//---------------------------------------------------------------------------
